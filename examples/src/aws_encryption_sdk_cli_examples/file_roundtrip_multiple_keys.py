...
def run(tmpdir):
    ...
    encrypt_command = f"bin/encrypt_file_multiple_keys.sh {filename} {cmk1} {cmk2} {tmpdir}"
    ...
    decrypt_command = f"bin/decrypt_file_multiple_keys.sh {ciphertext_file} {cmk1} {cmk2} {tmpdir}"
