...
def run(tmpdir):
    """Runner function for encrypt and decrypt file example."""
    ...
    encrypt_command = "encrypt_file.sh {} {} {}".format(filename, cmk, tmpdir)
    ...
    decrypt_command = "decrypt_file.sh {} {} {}".format(ciphertext_file, cmk, tmpdir)
